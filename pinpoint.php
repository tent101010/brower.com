...
?>
        <div id="rightCol">
            ...
            <div class="col3of3">
                <a class="zoomMe" id="pinpoint"><img alt="See image enlarged" height="94" id="enlarge" src="images/zoom_in_91x94.png" style="display:none;" width="91" /></a>
            </div><br class="clearLt">
        </div><br class="clearLt">
        <div id="popup" style="background:url('images/pinpointFull.jpg') no-repeat; height:883px;">
