...
?>
        <div id="rightCol">
            ...
            <div class="col3of3">
                <a class="zoomMe" id="cks"><img alt="See image enlarged" height="94" id="enlarge" src="images/zoom_in_91x94.png" style="display:none;" width="91" /></a>
            </div><br class="clearLt">
        </div><br class="clearLt">
        <div id="popup" style="background:url('images/USWebCKSAdFull.gif') no-repeat; height:1086px;">
            <img id="closeBtn" src="images/close.png" height="16" width="16" alt="close" />
        </div>
