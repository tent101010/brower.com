...
?>
        <div id="rightCol">
            ...
            <div class="col3of3">
                <a class="zoomMe" id="tioga"><img alt="See image enlarged" height="94" id="enlarge" src="images/zoom_in_91x94.png" style="display:none;" width="91" /></a>
            </div><br class="clearLt">
        </div><br class="clearLt">
        <div id="popup" style="background:url('images/tiogaWebSiteFull.jpg') no-repeat; height:688px;">
            <img id="closeBtnInMore" src="images/close.png" height="16" width="16" alt="close" name="closeBtn">
        </div>
